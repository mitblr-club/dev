...
const data = [
  ...
  },
  {
    ...
    Icon : <Icons.linkedin className="h-10 w-10"/>
  },
  {
    Title: 'Logistics&Ops',
    Description:
      ...
      Icon : <Icons.twitter className="h-10 w-10"/>
  },
];
